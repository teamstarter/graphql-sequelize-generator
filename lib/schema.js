...
function generateSchema(_a) {
    ...
    var definition = __assign({ query: query_1["default"](graphqlSchemaDeclaration, types.outputTypes, models, globalPreCallback) }, (mutationExists && {
        mutation: mutation_1["default"](graphqlSchemaDeclaration, types.inputTypes, types.outputTypes, models, globalPreCallback, customMutations, pubSubInstance, callWebhook)
    }));
