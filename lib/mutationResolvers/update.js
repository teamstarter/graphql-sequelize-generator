        ...
        resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 16:
                        if (pubSubInstance) {
                            pubSubInstance.publish("".concat(modelName, "Updated"), (_c = {},
                                _c["".concat(modelName, "Updated")] = entity.get(),
                                _c));
                        }
                        return [4 /*yield*/, (0, callModelWebhook_1["default"])(modelName, graphqlModelDeclaration.webhooks, 'update', context, __assign({}, snapshotBeforeUpdate), callWebhook)];
                    case 17:
                        _d.sent();
