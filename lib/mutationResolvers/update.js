            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 13:
                        ...
                        hookData = __assign({}, entity);
                        afterHandle = globalPreCallback('updateAfter');
                        return [4 /*yield*/, graphqlModelDeclaration.update.after(entity, snapshotBeforeUpdate, source, args, context, info, setWebhookData_1["default"](entity))];
                    case 14:
                        ...
                        return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'update', context, hookData.data, callWebhook)];
                    case 15:
                        _d.sent();
                    ...
                    case 16:
                        ...
                        return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'update', context, __assign({}, entity), callWebhook)];
                    case 17:
                        _d.sent();
