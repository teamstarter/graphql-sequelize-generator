            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, graphqlModelDeclaration["delete"].after(entity, source, args, context, info, setWebhookData_1["default"](hookData))];
                    case 13:
                        _c.sent();
                        if (afterHandle) {
                            afterHandle();
                        }
                        return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'delete', context, hookData.data, callWebhook)];
                    case 14:
                        _c.sent();
                        _c.label = 15;
                    case 15: return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'delete', context, __assign({}, snapshotBeforeDelete), callWebhook)];
                    case 16:
                        _c.sent();
