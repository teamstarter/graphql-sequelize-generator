...
function generateMutationDelete(modelName, graphqlModelDeclaration, models, globalPreCallback, pubSubInstance, callWebhook) {
    ...
    return {
        ...
        resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            var where, beforeList, beforeList_1, beforeList_1_1, before, handle, e_1_1, beforeHandle, entity, snapshotBeforeDelete, rowDeleted, hookData, afterHandle;
            var e_1, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        ...
                        beforeList = 'length' in graphqlModelDeclaration.before
                    ...
                    case 12:
                        ...
                        ;
                        if (pubSubInstance) {
                            pubSubInstance.publish("".concat(modelName, "Deleted"), (_b = {},
                                _b["".concat(modelName, "Deleted")] = entity.get(),
                                _b));
                        }
                        if (!(graphqlModelDeclaration["delete"] &&
                    ...
                    case 13:
                        ...
                        return [4 /*yield*/, (0, callModelWebhook_1["default"])(modelName, graphqlModelDeclaration.webhooks, 'delete', context, hookData.data, callWebhook)];
                    case 14:
                        _c.sent();
                        _c.label = 15;
                    case 15: return [4 /*yield*/, (0, callModelWebhook_1["default"])(modelName, graphqlModelDeclaration.webhooks, 'delete', context, __assign({}, snapshotBeforeDelete), callWebhook)];
                    case 16:
                        _c.sent();
                        return [2 /*return*/, rowDeleted];
                }
            });
        }); }
    };
