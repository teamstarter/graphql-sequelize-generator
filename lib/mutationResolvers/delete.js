...
function generateMutationDelete(modelName, graphqlModelDeclaration, models, globalPreCallback, pubSubInstance, callWebhook) {
    ...
    return {
        ...
        resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            var where, beforeList, beforeList_1, beforeList_1_1, before, handle, e_1_1, beforeHandle, entity, rowDeleted, hookData, afterHandle;
            var e_1, _a, _b;
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 12:
                        ...
                        return [4 /*yield*/, graphqlModelDeclaration["delete"].after(entity, source, args, context, info, setWebhookData_1["default"](entity))];
                    case 13:
                        _c.sent();
                        if (afterHandle) {
                            afterHandle();
                    ...
                    case 14:
                        _c.sent();
                        _c.label = 15;
                    case 15: return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'create', context, __assign({}, entity), callWebhook)];
                    case 16:
                        _c.sent();
