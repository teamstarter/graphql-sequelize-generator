...
function generateMutationCreate(modelName, inputType, outputType, model, graphqlModelDeclaration, globalPreCallback, pubSubInstance, callWebhook) {
    ...
    return {
        ...
        resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            var attributes, beforeList, beforeList_1, beforeList_1_1, before, handle, e_1_1, beforeHandle, preventDuplicateAttributes_1, filters, entityDuplicate, newEntity, afterHandle, hookData, updatedEntity;
            var e_1, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 14:
                        newEntity = _d.sent();
                        if (!(graphqlModelDeclaration.create &&
                            graphqlModelDeclaration.create.after)) return [3 /*break*/, 17];
                        afterHandle = globalPreCallback('createAfter');
                        hookData = __assign({}, newEntity);
                        return [4 /*yield*/, graphqlModelDeclaration.create.after(newEntity, source, args, context, info, setWebhookData_1["default"](newEntity))];
                    case 15:
                        ...
                        return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'create', context, hookData.data, callWebhook)];
                    case 16:
                        _d.sent();
                    ...
                    case 17:
                        ...
                        return [4 /*yield*/, callModelWebhook_1["default"](modelName, graphqlModelDeclaration.webhooks, 'create', context, __assign({}, newEntity), callWebhook)];
                    case 18:
                        _d.sent();
