        ...
        resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 10:
                        if (!(graphqlModelDeclaration.create &&
                            graphqlModelDeclaration.create.preventDuplicateOnAttributes)) return [3 /*break*/, 12];
                    ...
                    case 11:
                        ...
                        console.log(entityDuplicate);
                        if (entityDuplicate) {
                            return [2 /*return*/, entityDuplicate];
                        }
                        _d.label = 12;
                    case 12: return [4 /*yield*/, model.create(attributes)];
                    case 13:
                        newEntity = _d.sent();
                        if (!(graphqlModelDeclaration.create &&
                            graphqlModelDeclaration.create.after)) return [3 /*break*/, 15];
