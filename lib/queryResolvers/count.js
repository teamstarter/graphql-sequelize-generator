...
function countResolver(model, schemaDeclaration, globalPreCallback) {
    ...
    var listBefore = schemaDeclaration.list && schemaDeclaration.list.beforeList
        ? schemaDeclaration.list.beforeList
        : undefined;
    // Count uses the same before function as the list, except if specified otherwise
    var countBefore = schemaDeclaration.count && schemaDeclaration.count.beforeList
    ...
    return function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_d) {
            switch (_d.label) {
                ...
                case 17:
                    count = _d.sent();
                    if (!(schemaDeclaration.count && schemaDeclaration.count.afterList)) return [3 /*break*/, 26];
                    afterList = Array.isArray(schemaDeclaration.count.afterList)
