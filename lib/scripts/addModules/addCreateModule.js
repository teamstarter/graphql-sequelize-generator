...
function addCreateModule(models, modelName, attributes, token) {
    ...
    axios_1["default"](config)
        ...
        var configApi = {
            method: 'put',
            url: "https://api.integromat.com/v1/app/test-app-894954/1/module/create" + synchronizeWithIntegromat_1.capitalize(modelName) + "/api",
            headers: {
                Authorization: "Token " + token,
                'x-imt-apps-sdk-version': '1.0.0',
        ...
        var configExpect = {
            method: 'put',
            url: "https://api.integromat.com/v1/app/test-app-894954/1/module/create" + synchronizeWithIntegromat_1.capitalize(modelName) + "/expect",
            headers: {
                Authorization: "Token " + token,
                'x-imt-apps-sdk-version': '1.0.0',
                'Content-Type': 'application/jsonc'
