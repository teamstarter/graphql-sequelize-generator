...
function getModelsFields(allSchemaDeclarations, outputTypes, models, globalPreCallback) {
    return Object.keys(outputTypes).reduce(function (fields, modelTypeName) {
        ...
        var result = schemaDeclaration.actions.indexOf('count') > -1
            ? __assign(__assign({}, fields), (_a = {}, _a[modelType.name] = listResolver_1["default"](modelType, modelTypeName, allSchemaDeclarations, outputTypes, models, globalPreCallback), _a[modelType.name + "Count"] = {
            ...
            }, _a)) : __assign(__assign({}, fields), (_b = {}, _b[modelType.name] = listResolver_1["default"](modelType, modelTypeName, allSchemaDeclarations, outputTypes, models, globalPreCallback), _b));
        return result;
    }, {});
}
