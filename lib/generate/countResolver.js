        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    beforeList = typeof schemaDeclaration.before.length !== 'undefined'
                        ? schemaDeclaration.before
                        : [schemaDeclaration.before];
                    _b.label = 1;
                case 1:
                ...
                case 8:
                    ...
                    return [4 /*yield*/, countBefore(graphql_sequelize_1.argsToFindOptions["default"](args, Object.keys(model.rawAttributes)), args, context, info)];
                case 9:
                ...
                case 10: return [2 /*return*/, model.count(graphql_sequelize_1.argsToFindOptions["default"](args, Object.keys(model.rawAttributes)))];
            }
        });
    }); };
}
