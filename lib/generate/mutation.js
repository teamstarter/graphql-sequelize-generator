...
function generateMutation(graphqlSchemaDeclaration, inputTypes, outputTypes, models, globalPreCallback, customMutations, pubSubInstance) {
        ...
        if (actions.includes('create')) {
            mutations[modelName + 'Create'] =
                graphqlSchemaDeclaration[modelName].create &&
                    ...
                    ? graphqlSchemaDeclaration[modelName].create
                    : mutationCreateResolver_1["default"](modelName, inputType, outputType, model, graphqlSchemaDeclaration[modelName], globalPreCallback, pubSubInstance);
        }
        if (actions.includes('update')) {
            mutations[modelName + 'Update'] =
                graphqlSchemaDeclaration[modelName].update &&
                    ...
                    ? graphqlSchemaDeclaration[modelName].update
                    : mutationUpdateResolver_1["default"](modelName, inputType, outputType, model, graphqlSchemaDeclaration[modelName], models, globalPreCallback, pubSubInstance);
        }
        if (actions.includes('delete')) {
            mutations[modelName + 'Delete'] =
                graphqlSchemaDeclaration[modelName]["delete"] &&
                    ...
                    ? graphqlSchemaDeclaration[modelName]["delete"]
                    : mutationDeleteResolver_1["default"](modelName, inputType, outputType, graphqlSchemaDeclaration[modelName], models, globalPreCallback, pubSubInstance);
        }
