 ...
 */
function generateMutationUpdate(modelName, inputType, outputType, model, graphqlModelDeclaration, models, globalPreCallback, pubSubInstance) {
    var _a;
    var _this = this;
    ...
    return {
        ...
        resolve: function (source, args, context, info) { return __awaiter(_this, void 0, void 0, function () {
            var data, beforeList, beforeList_1, beforeList_1_1, before, handle, e_1_1, beforeHandle, entity, snapshotBeforeUpdate, afterHandle, updatedEntity;
            var e_1, _a, _b, _c;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    ...
                    case 13:
                        _d.sent();
                        if (!(graphqlModelDeclaration.update &&
                            graphqlModelDeclaration.update.after)) return [3 /*break*/, 15];
                        afterHandle = globalPreCallback('updateAfter');
                        return [4 /*yield*/, graphqlModelDeclaration.update.after(entity, snapshotBeforeUpdate, source, args, context, info)];
                    case 14:
                        ...
                        if (pubSubInstance) {
                            pubSubInstance.publish(modelName + "Updated", (_b = {},
                                _b[modelName + "Updated"] = updatedEntity.get(),
                                _b));
                        }
                        return [2 /*return*/, updatedEntity];
                    case 15:
                        if (pubSubInstance) {
                            pubSubInstance.publish(modelName + "Updated", (_c = {},
                                _c[modelName + "Updated"] = entity.get(),
                                _c));
                        }
