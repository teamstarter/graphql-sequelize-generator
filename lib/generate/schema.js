...
var rootQueryResolver_1 = __importDefault(require("./rootQueryResolver"));
...
function generateSchema(_a) {
    ...
    var definition = __assign({ query: rootQueryResolver_1["default"](graphqlSchemaDeclaration, types.outputTypes, models, globalPreCallback) }, (mutationExists && {
