...
function generateApolloServer(_a) {
    ...
    return new apollo_server_express_1.ApolloServer(__assign({ schema: graphqlSchema, plugins: [(0, apollo_server_core_1.ApolloServerPluginCacheControlDisabled)()] }, apolloServerOptions));
}
